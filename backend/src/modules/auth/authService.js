...
exports.register = async (data, role) => {
  ...
  const redirectUrl = `https://qwikkofront.onrender.com/${role}/login`;
...
exports.forgotPassword = async (email) => {
  const link = await admin.auth().generatePasswordResetLink(email, {
    url: `https://qwikkofront.onrender.com/customer/password-updated?email=${encodeURIComponent(email)}`,
  });
